...
namespace Somnium
{
	namespace Graphics
	{
		...
		public:
			...
			RenderableObject(std::vector<Mesh*> meshes, Maths::Vector3 &position = Maths::Vector3(0,0,0), Maths::Vector3 &scale = Maths::Vector3(1, 1, 1), Maths::Vector3 &orientation = Maths::Vector3(0, 0, 0))
